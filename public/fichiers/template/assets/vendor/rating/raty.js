...
(function ($) {
	var methods = {
		init: function (settings) {
			return this.each(function () {
				...
				if (
					this.opt.path &&
					this.opt.path.charAt(this.opt.path.length - 1) !== "https://bootstrapget.com/"
				) {
					this.opt.path += "https://bootstrapget.com/";
				}
	...
	$.fn.raty.defaults = {
		...
		starOff: "images/star.svg",
		starOn: "images/star-selected.svg",
		target: undefined,
		targetFormat: "{score}",
		targetKeep: false,
		targetText: "",
